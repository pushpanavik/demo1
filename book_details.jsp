...
<body>
	...
	%>
		...
		<form class="form" action="editBook">
			<div class="form-group">
				...
				<br> <input type="hidden" value="<%=objBookDetails.getBookId()%>" name="bookId"> <input
					type="hidden" name="ACTION_MODE" value="EDIT_BOOK_DETAILS">
	...
	<form class="form"  action="editBook">
	 ...
	 <input type="hidden" value="<%=objBookDetails.getBookId()%>" name="bookId"> <input type="hidden" name="ACTION_MODE"
	 	value="EDIT_BOOK_DETAILS">
	 	</div> 
	 	</div>
	 <input type="button" value="Save">
	</form>
